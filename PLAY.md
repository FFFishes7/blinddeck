...
| Save      | `save PATH`                                   | Any in-run state (not `MENU`). e.g. `save run.jkr`. Relative paths save under `C:\Users\<username>\AppData\Roaming\Balatro\`.                                                          |
...
| Command           | When                                                | Notes                                                                                         |
| ----------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `save PATH`       | Active run (rows above; not `MENU`)                 | e.g. `save run.jkr`; relative paths save under `C:\Users\<username>\AppData\Roaming\Balatro\` |
