...
* add back the test target in Makefile ([ebfbfb5](https://github.com/FFFishes7/balatrobot/commit/ebfbfb5dfac75152bd127ba254bc361b321e7d72))
* add balatro.py python script ([c0ae64f](https://github.com/FFFishes7/balatrobot/commit/c0ae64fb2c95d57c995cfcaadaa8669cb12b7877))
* add cli entry point for balatrobot ([394e8c8](https://github.com/FFFishes7/balatrobot/commit/394e8c885c12ac0eab8e1e4bae838688fc16d5b6))
* add fps cap setting ([8fefa49](https://github.com/FFFishes7/balatrobot/commit/8fefa49f5c34dafa1eadd551ccaef534606d6bd2))
* add gamespeed, animation_fps, no_reduced_motion settings ([f6c1f81](https://github.com/FFFishes7/balatrobot/commit/f6c1f8176313e875fadaa6b476f6f23b680299d9))
* add gamestate menu and start endpoints to balatrobot loading ([6aebc4a](https://github.com/FFFishes7/balatrobot/commit/6aebc4a3e08852c87c9b933b30d09607f930579d))
* add new skip endpoint to balatrobot.lua ([b02b675](https://github.com/FFFishes7/balatrobot/commit/b02b6753798e0d01f025403be2878bbb6560579e))
* add option to disable shaders with env var BALATROBOT_NO_SHADERS ([6be3497](https://github.com/FFFishes7/balatrobot/commit/6be3497bb96c16dccb59829867b306b112dd399b))
* add pixel art smoothing setting ([b5eff97](https://github.com/FFFishes7/balatrobot/commit/b5eff97ebad67cd189db3cf3f5203f461ad7f952))
* add select endpoint to balatrobot.lua ([0414d33](https://github.com/FFFishes7/balatrobot/commit/0414d335b8ba2c6fe2425174750119bcd20e05ab))
* **balatrobot:** add CLI interface and entry points ([429ee26](https://github.com/FFFishes7/balatrobot/commit/429ee2697a1b7186f1c87f05231f06060bbe4471))
* **balatrobot:** add configuration and path utilities ([8fa562a](https://github.com/FFFishes7/balatrobot/commit/8fa562ad16cb8b8a9d7021ff6b1a569767c47ffe))
* **balatrobot:** add HTTP health check utility ([b8fe42c](https://github.com/FFFishes7/balatrobot/commit/b8fe42cb288c99ebc1b8fbdc8217a67f2dee88cf))
* **balatrobot:** add macOS and native platform launchers ([49ed21d](https://github.com/FFFishes7/balatrobot/commit/49ed21d2c678e589bddd4f1318a68906dabb5860))
* **balatrobot:** add multi-instance manager ([57d1dac](https://github.com/FFFishes7/balatrobot/commit/57d1dac3dcbfcfd7785997d3665837d9cbb0ab40))
* **balatrobot:** add platform abstraction layer ([d57b4cd](https://github.com/FFFishes7/balatrobot/commit/d57b4cd89f3f2f890b9e881e4ceed6b9ee142a5d))
* **balatrobot:** add Windows support to CLI ([843a1b7](https://github.com/FFFishes7/balatrobot/commit/843a1b7b6dbf049a1cc1d1510714519d642aa0c2))
* **balatrobot:** refactor balatrobot cli ([0a3390c](https://github.com/FFFishes7/balatrobot/commit/0a3390c4e906be82fea867fca85e60877c9484c2))
* **cli:** add integration tests for new Typer CLI ([dd18bb7](https://github.com/FFFishes7/balatrobot/commit/dd18bb7bd3b193ef66adb6a344c7cf3662cf749d))
* **core:** add boolean and table types to validator ([54561d2](https://github.com/FFFishes7/balatrobot/commit/54561d293dbf81c4a10fdc0ea89e714797d7f397))
* **fixtures:** update generate.py to use httpx ([abc2293](https://github.com/FFFishes7/balatrobot/commit/abc229312686bfa33905e373fdae398bf00c664d))
* **lua.core:** add rpc.discover endpoint to the dispatcher ([fa2f026](https://github.com/FFFishes7/balatrobot/commit/fa2f026e1c348c2892791d8d7cb2fe656b194389))
* **lua.core:** add state name lookup table ([6de65f4](https://github.com/FFFishes7/balatrobot/commit/6de65f484de60bf28f3f50d7d5b3469da0d95f17))
* **lua.core:** move from raw TCP to HTTP server ([584aaf8](https://github.com/FFFishes7/balatrobot/commit/584aaf8d5df032bddbcec9588d2bf564d074ca2a))
* **lua.endpoints:** add `add` endpoint ([d5e5e9c](https://github.com/FFFishes7/balatrobot/commit/d5e5e9c1bba3d25653865f60c5e36dc563eafad1))
* **lua.endpoints:** add `pack` endpoint ([32ff3eb](https://github.com/FFFishes7/balatrobot/commit/32ff3eb1aae56f81b78070c7d4b080987a29aea1))
* **lua.endpoints:** add `use` endpoint ([48fa0a1](https://github.com/FFFishes7/balatrobot/commit/48fa0a11cac2ffd3d212bcc30ae50451dd8e97ac))
* **lua.endpoints:** add buy endpoint ([3872f44](https://github.com/FFFishes7/balatrobot/commit/3872f449ee42f53d9f04345ded4fe6ebeafb03ac))
* **lua.endpoints:** add cash out endpoint ([c0aeeb5](https://github.com/FFFishes7/balatrobot/commit/c0aeeb522c5b3142dd4ebfcfa1175ca7ce88af01))
* **lua.endpoints:** add discard endpoint ([7e25460](https://github.com/FFFishes7/balatrobot/commit/7e25460d3540038a82a5acfc4e090f2ca581cfed))
* **lua.endpoints:** add gamestate endpoint ([4ceb27c](https://github.com/FFFishes7/balatrobot/commit/4ceb27c1dc0a8ce06d7b087ff25b47147fb50929))
* **lua.endpoints:** add load endpoint ([c3e3d0d](https://github.com/FFFishes7/balatrobot/commit/c3e3d0d1ba9d9f731704b8064875e4e30fad3203))
* **lua.endpoints:** add menu endpoint ([8dba721](https://github.com/FFFishes7/balatrobot/commit/8dba7211b92095215825649ed1045c3abc9bd152))
* **lua.endpoints:** add next_round endpoint ([5ea895d](https://github.com/FFFishes7/balatrobot/commit/5ea895daf38af1330624b1227cc51deb819ecf57))
* **lua.endpoints:** add pack endpoint ([9d3031f](https://github.com/FFFishes7/balatrobot/commit/9d3031f9405145d608848eacab0d6aa90aba0f2c))
* **lua.endpoints:** add play endpoint ([72636f4](https://github.com/FFFishes7/balatrobot/commit/72636f4ff1286948ddedf59fe7e0d87bcc7bb599))
* **lua.endpoints:** add rearrange endpoint ([665d5c1](https://github.com/FFFishes7/balatrobot/commit/665d5c10dea20b9992ca92624fcc8eae2bb47a1c))
* **lua.endpoints:** add reroll endpoint ([1fefae7](https://github.com/FFFishes7/balatrobot/commit/1fefae7551972790ee738c7fcf919532d1e79a42))
* **lua.endpoints:** add save endpoint ([1b06580](https://github.com/FFFishes7/balatrobot/commit/1b06580fdf2d2f0057e384b2eab31db1ac22c531))
* **lua.endpoints:** add screenshot endpoint ([017e463](https://github.com/FFFishes7/balatrobot/commit/017e4633af98e43ee2983593c99f2217e26f10f2))
* **lua.endpoints:** add select endpoint ([37e4dec](https://github.com/FFFishes7/balatrobot/commit/37e4decacce5eae9798936c5418cced684dfa430))
* **lua.endpoints:** add sell endpoint ([5595b7e](https://github.com/FFFishes7/balatrobot/commit/5595b7eb4517def3a9148d8f3324f87f4e6e4967))
* **lua.endpoints:** add set endpoint ([8084d63](https://github.com/FFFishes7/balatrobot/commit/8084d6371c109f6f7266649207f4a572ce7cb3be))
* **lua.endpoints:** add skip endpoint ([3a2722e](https://github.com/FFFishes7/balatrobot/commit/3a2722e5d5e344b2370c394b24ac9167438967a4))
* **lua.endpoints:** add start endpoint ([f8fdd97](https://github.com/FFFishes7/balatrobot/commit/f8fdd9710a9a10371393621667224ff441393908))
* **lua.endpoints:** add support for adding packs to the `add` endpoint ([41374a7](https://github.com/FFFishes7/balatrobot/commit/41374a718a1616b1e7e5298a510cac27de624771))
* **lua.endpoints:** add support for modifiers in the `add` endpoint ([01eff36](https://github.com/FFFishes7/balatrobot/commit/01eff369e6f2bcab900dd54a17a9f43c168873cd))
* **lua.endpoints:** add types for args for various endpoints ([d7bb418](https://github.com/FFFishes7/balatrobot/commit/d7bb418374a4db41ef4f7ff4a2c119f9f8787866))
* **lua.endpoints:** allow rearranging cards during booster pack state ([16e4170](https://github.com/FFFishes7/balatrobot/commit/16e417074beaa006f71d34d809d7c7f1248971f5))
* **lua.endpoints:** extend rearrange to pack state ([15f282c](https://github.com/FFFishes7/balatrobot/commit/15f282c870e771970ddef3cb2ceca8a29eee1649))
* **lua.utils:** add `cards` field to gamestate ([8447855](https://github.com/FFFishes7/balatrobot/commit/8447855365c08db38cd555810ea92d6cf0098ff8))
* **lua.utils:** add BB_API global namespace for calling endpoints via /eval ([abbec83](https://github.com/FFFishes7/balatrobot/commit/abbec8375086fa6e6fdcc6b15983542c365db750))
* **lua.utils:** add booster packs to gamestate ([9a7a8d3](https://github.com/FFFishes7/balatrobot/commit/9a7a8d31bce5039140afe356e77757110dc11b95))
* **lua.utils:** add CardKey schema to openrpc.json ([89cbda9](https://github.com/FFFishes7/balatrobot/commit/89cbda9a7fbebe353f3ff2ce24503e22203416d1))
* **lua.utils:** add descriptions to openrpc.json enums ([78812f7](https://github.com/FFFishes7/balatrobot/commit/78812f710c5d9c88fe63b7e6fccfbc94e5f53742))
* **lua.utils:** add gamestate.check_game_over() ([19a0a51](https://github.com/FFFishes7/balatrobot/commit/19a0a515d3096d6352b85e129dcfb3f61591d9dd))
* **lua.utils:** add gamestate.lua to utils ([c13f56e](https://github.com/FFFishes7/balatrobot/commit/c13f56e6716c12028f0c0d2d67b2db548bab57f5))
* **lua.utils:** add openrpc.json schema ([fecb299](https://github.com/FFFishes7/balatrobot/commit/fecb299b4652711198868758db8638e55248d322))
* **lua.utils:** add pack field to gamestate ([4283eb5](https://github.com/FFFishes7/balatrobot/commit/4283eb5cc870e7e57bc47e18af26e6c69edee615))
* **lua.utils:** add pack keys enums ([d8cdb33](https://github.com/FFFishes7/balatrobot/commit/d8cdb335331332be2b0c2c64bdfbee8f1b10d602))
* **lua.utils:** add request/response types ([a930c90](https://github.com/FFFishes7/balatrobot/commit/a930c904b421215f1a830e09ece32604f1c62ca2))
* **lua.utils:** add SCHEMA_INVALID_VALUE error ([c52b2e6](https://github.com/FFFishes7/balatrobot/commit/c52b2e639a1a5d3ea5dbcf32746fafd0770b7c61))
* **lua.utils:** add screenshot endpoint types ([3264152](https://github.com/FFFishes7/balatrobot/commit/3264152d417f16397a278101e0a240b3777a842a))
* **lua.utils:** add types for gamestate and endpoint ([9b9283c](https://github.com/FFFishes7/balatrobot/commit/9b9283c6a0cd164d3ed9ce70e7c96352facb6fe2))
* **lua.utils:** improve enums in gamestate ([3c1195a](https://github.com/FFFishes7/balatrobot/commit/3c1195a4aa8ec594bc3657ac640a7872353b509c))
* **lua.utils:** improve response and request types ([9296b01](https://github.com/FFFishes7/balatrobot/commit/9296b01a6ed0ed66bf880e9310b41d4066a65aa1))
* **lua.utils:** move enums to enums.lua and add Card.Key enums ([d477d66](https://github.com/FFFishes7/balatrobot/commit/d477d66eb1dc6e73c9a254ca81a67c61cd81af4c))
* **lua.utils:** new simplify error codes ([e7db3f5](https://github.com/FFFishes7/balatrobot/commit/e7db3f593f6a91c4ad4e01d503ddda0c1171141e))
* **lua.utils:** update types with new dispatcher and server fields ([39d6f5c](https://github.com/FFFishes7/balatrobot/commit/39d6f5ce9446c66abbcd062219262f6bc8595556))
* **lua:** add BalatroBot settings ([4f73a0e](https://github.com/FFFishes7/balatrobot/commit/4f73a0e81426978af07e858aecf6f1f699144c39))
* **lua:** add close previous client socket on new connection ([3684285](https://github.com/FFFishes7/balatrobot/commit/36842850f21ad4d8ac22dc1c124ab20606dac8c8))
* **lua:** add debugger utils ([6308827](https://github.com/FFFishes7/balatrobot/commit/63088272b0687aa726d80c0f5e0f5fce8f2adfc6))
* **lua:** add dispatcher module ([a20359d](https://github.com/FFFishes7/balatrobot/commit/a20359d2bc53d6d127c6e2504c87ff4c40fe60ad))
* **lua:** add error codes utils ([58bf3fb](https://github.com/FFFishes7/balatrobot/commit/58bf3fbe083266aa8770447929aa430515193e7d))
* **lua:** add errors for load and save ([b784ffe](https://github.com/FFFishes7/balatrobot/commit/b784ffe98978450b951777276b6deba08caab2c0))
* **lua:** add health endpoint ([0ec3b0c](https://github.com/FFFishes7/balatrobot/commit/0ec3b0ceb0e8d91f203779f5a40e7a6cebc4605f))
* **lua:** add load and save endpoints ([e9ba224](https://github.com/FFFishes7/balatrobot/commit/e9ba224ba69001f7610dfd7fe667e6192c22f1e1))
* **lua:** add server module ([09e7b52](https://github.com/FFFishes7/balatrobot/commit/09e7b522814e42d5fe87ece8fd3e501b4d2070e5))
* **lua:** add test endpoints ([c05f444](https://github.com/FFFishes7/balatrobot/commit/c05f444ff18072b552fe75f1aba1998a748ffecd))
* **lua:** add validator module ([430b436](https://github.com/FFFishes7/balatrobot/commit/430b43628d518caf025e448df7215e9a2cde0b59))
* **lua:** improve logging for endpoints ([680fd45](https://github.com/FFFishes7/balatrobot/commit/680fd45c2711c58a461c51cab04e42e5be0fb767))
* **platform:** add linux support through proton ([5c06e3f](https://github.com/FFFishes7/balatrobot/commit/5c06e3f274ffa25df34d38dfffa5fd3390dfa3b0)), closes [#128](https://github.com/FFFishes7/balatrobot/issues/128) [#162](https://github.com/FFFishes7/balatrobot/issues/162) [#184](https://github.com/FFFishes7/balatrobot/issues/184)
* **scripts:** add Balatro launchers for Linux, macOS, and Windows ([fd5dcef](https://github.com/FFFishes7/balatrobot/commit/fd5dcef3b99e8de919086ed4de64e2d1b738e946))
* update balatrobot.lua ([b90d772](https://github.com/FFFishes7/balatrobot/commit/b90d77286f382e8d99f46c0a01caf4d7f6c60e00))
* update to v1.0.0 ([0fa8bf7](https://github.com/FFFishes7/balatrobot/commit/0fa8bf74b8c9b929191f2ddce4a3724d5b4152c7))
* use balatro launcher script based on OS in Makefile ([c50fd03](https://github.com/FFFishes7/balatrobot/commit/c50fd03020e1afd09e482c266bf076721a98df4c))
* **utils.gamestate:** fix rank and suit and add key field to Card ([7d04404](https://github.com/FFFishes7/balatrobot/commit/7d0440497698c180dbbfa6384f04ea21d9d19a61))


### Bug Fixes

* add --debug flag to balatro.py ([c40670b](https://github.com/FFFishes7/balatrobot/commit/c40670b1cc0c62e37f7d3aed0bf939b48697c501))
* add GAME_OVER check to love.update ([3919fa3](https://github.com/FFFishes7/balatrobot/commit/3919fa366f0023ad8bcfd3bc85bbe7861483bc6c))
* add timeout to socket.recv ([12d086a](https://github.com/FFFishes7/balatrobot/commit/12d086a80294f08fe449012c2a3a27708d7aada0))
* **balatrbot.platforms:** add NotImplementedError for Linux and Windows ([7e3d666](https://github.com/FFFishes7/balatrobot/commit/7e3d666c68549f8a9ae12e0e710ab1d55b6fae8b))
* **balatrobot.cli:** more strict error handling using httpx ([05b5971](https://github.com/FFFishes7/balatrobot/commit/05b5971af3f067bdb64c619a406bab6ba9e04d5a))
* **balatrobot:** add session_id to BalatroInstance ([79230dd](https://github.com/FFFishes7/balatrobot/commit/79230dd0eed2afd8cd24430a77ff0abd181c1d82))
* **balatrobot:** increase timeout for health check ([64511d7](https://github.com/FFFishes7/balatrobot/commit/64511d79e31788e89a4220ab42552b63dc278fe8))
* **balatrobot:** remove unused paths ([1007aee](https://github.com/FFFishes7/balatrobot/commit/1007aee20c662b2bf3bc289a8c9cbf8aa6078d3a))
* **ci:** update release workflow to sync openrpc.json version ([905609f](https://github.com/FFFishes7/balatrobot/commit/905609fbf0c72983a63bfabc8fce09825650f311))
* **fixtures:** add $schema to fixtures schema ([db1f2d6](https://github.com/FFFishes7/balatrobot/commit/db1f2d635bf41f5dce79ee385d7d160f5b76dee2))
* **gamestate:** try to fix memory leaks in UI nodes - again ([42ec1f3](https://github.com/FFFishes7/balatrobot/commit/42ec1f3f56aea2f1f3d34b865ab7e68986e9fd4f))
* kill processes on a specific port in balatro.py ([b21058a](https://github.com/FFFishes7/balatrobot/commit/b21058ad02769c189b4afc7ae0332f5d093fe09e))
* **linux:** respect pre-existing STEAM_COMPAT_DATA_PATH and STEAM_COMPAT_CLIENT_INSTALL_PATH env vars ([ef75d31](https://github.com/FFFishes7/balatrobot/commit/ef75d3117c9a57363b79a98066b67509a8070bc1))
* **lua.core:** close server on error ([030ff7c](https://github.com/FFFishes7/balatrobot/commit/030ff7c06e9f5ffa9bf5e70208ff880e823c8af7))
* **lua.core:** trigger render on api using BB_RENDER variable ([78b1285](https://github.com/FFFishes7/balatrobot/commit/78b1285492ceb58da2ae351b2c84eba568b7aab9))
* **lua.endpoint:** add nil checks for race condition in `next_round` endpoint ([ce08dcc](https://github.com/FFFishes7/balatrobot/commit/ce08dcc5a13b102ecd0ac56631791903487f7fea))
* **lua.endpoint:** properly wait for SHOP state ([eb1c924](https://github.com/FFFishes7/balatrobot/commit/eb1c9248bfa2abe650343109b48050d87d32064a))
* **lua.endpoints:** account for Credit Card joker via bankrupt_at ([2132dee](https://github.com/FFFishes7/balatrobot/commit/2132dee65d7f86e425947cfda0bbecf1b596268f))
* **lua.endpoints:** add check state loading for load endpoint ([af50437](https://github.com/FFFishes7/balatrobot/commit/af50437a2f02bff0f69312e8cf03f15d2368a0cd))
* **lua.endpoints:** add return after error in skip endpoint ([96e4e44](https://github.com/FFFishes7/balatrobot/commit/96e4e442d94e4feeea83cce65ae7ec81977fd220))
* **lua.endpoints:** await hand to be loaded for Arcana/Spectral packs ([43e41a4](https://github.com/FFFishes7/balatrobot/commit/43e41a46f94718996a8f2d8f8b960148471f9cda))
* **lua.endpoints:** fix `pack` with mega packs with double target selection ([ba3e270](https://github.com/FFFishes7/balatrobot/commit/ba3e2700bb31ec90c16cbc1316ee2dc5771dbf7e))
* **lua.endpoints:** fix error message for invalid voucher/pack index in buy ([4af3d39](https://github.com/FFFishes7/balatrobot/commit/4af3d39c31a2575c7986c4cda81618ee5aa652fe))
* **lua.endpoints:** fix start endpoint check condition ([95d230c](https://github.com/FFFishes7/balatrobot/commit/95d230c309f0ff68cf911dea0624b4337a5716f6))
* **lua.endpoints:** fix test for `add` params validation types ([89c71db](https://github.com/FFFishes7/balatrobot/commit/89c71dbb7bba62100ece796007463ed2b7304635))
* **lua.endpoints:** fix type annotation for skip endpoint ([da89ca8](https://github.com/FFFishes7/balatrobot/commit/da89ca8f32f97db7624f1a1a3746bd1988cdca7f))
* **lua.endpoints:** improve await condition when buying a pack ([4993e77](https://github.com/FFFishes7/balatrobot/commit/4993e776d8fbcad138eaff63ac463818e8f0102f))
* **lua.endpoints:** improve wait condition for `play` endpoint ([3b905be](https://github.com/FFFishes7/balatrobot/commit/3b905be484208f62a9b24e86e54f6be6b5af8eac))
* **lua.endpoints:** properly check that the items in shop loaded ([67f5808](https://github.com/FFFishes7/balatrobot/commit/67f58085017789118f5af48ef312829f7a874417))
* **lua.endpoints:** properly wait for ROUND_EVAL and SHOP states in load ([19f3a21](https://github.com/FFFishes7/balatrobot/commit/19f3a211547fef9a66700f9bf65a0e7bf2f2bf8c))
* **lua.endpoints:** properly wait for ROUND_EVAL state ([f2184e7](https://github.com/FFFishes7/balatrobot/commit/f2184e7bffb0fb837d25bc47fe8faeef9a7aa43f))
* **lua.endpoints:** remove card count condition from `use` endpoint ([8dc5fed](https://github.com/FFFishes7/balatrobot/commit/8dc5fed8f69424e1c5fdb4b5a8df827817d3fd6f))
* **lua.endpoints:** remove getInfo check in load endpoint ([e446b27](https://github.com/FFFishes7/balatrobot/commit/e446b275ba4ae5c909557829861105377c4b83fa))
* **lua.endpoints:** remove no_delete flag from events for which it is not needed ([f5f9340](https://github.com/FFFishes7/balatrobot/commit/f5f934052f44f26c51b01b82326270c4240a1415))
* **lua.endpoints:** short circuit load if controller is locked or state is not complete ([d30a991](https://github.com/FFFishes7/balatrobot/commit/d30a991a02ecd51d3d6f1e26127175d950a7ca1f))
* **lua.endpoints:** skip materialize and check CONTROLLER state in `add` endpoint ([82c1003](https://github.com/FFFishes7/balatrobot/commit/82c100303a1d6622abb0b7f761c75f19570d0c91))
* **lua.endpoints:** suppress "Card area not instantiated" warnings during load ([4ff9c59](https://github.com/FFFishes7/balatrobot/commit/4ff9c59756f67989101448f561d9e265a503f023))
* **lua.endpoints:** use of area.config.card_count which is more reliable ([98bd561](https://github.com/FFFishes7/balatrobot/commit/98bd5613cad77cc2f12ab93157cb29e8c055d0c5))
* **lua.endpoints:** use port in temp file name in save and load endpoints ([cec88fe](https://github.com/FFFishes7/balatrobot/commit/cec88fe3f2a84fec1c8dbfdfc78adbfd20adbe86))
* **lua.endpoints:** wait for blind_select to properly finish ([43ad5e1](https://github.com/FFFishes7/balatrobot/commit/43ad5e17915668177d955dc2923acf4ce84752de))
* **lua.utils:** avoid to use hover to generate UI description ([11fc9f5](https://github.com/FFFishes7/balatrobot/commit/11fc9f54dfae9682233d7e2b135f1443f0dcc56f))
* **lua.utils:** remove " Card" suffix from enhancement in gamestate ([766d90c](https://github.com/FFFishes7/balatrobot/commit/766d90c07f2fdb729493242d8348d7f593199dcd))
* **lua.utils:** set the proper type for requires_state (`integer[]?`) ([5e494b1](https://github.com/FFFishes7/balatrobot/commit/5e494b1e6eef432d9d4fd5b1605526cb1e1fe04f))
* **lua.utils:** use appropriate field for the request in debugger ([d79a81d](https://github.com/FFFishes7/balatrobot/commit/d79a81d881f64f41293ac5d63ba23d916a29deab))
* **lua.utils:** use BB.DEBUGGER as prefix for debug messages in debugger.lua ([149cdcd](https://github.com/FFFishes7/balatrobot/commit/149cdcda9f2c050a3079e6f9db1050643dfcd765))
* **lua.utils:** use Card.Value.Rank|Suit instead Rank|Suit ([8174168](https://github.com/FFFishes7/balatrobot/commit/817416813e4923bbb435c6b26fa4fcb58918f158))
* **lua:** add missing test endpoint ([557fab1](https://github.com/FFFishes7/balatrobot/commit/557fab14edcea094f64a8b8fa0643f819db13cf5))
* **lua:** fix headless mode ([2fa55be](https://github.com/FFFishes7/balatrobot/commit/2fa55be55033f799f996035d51a2ebf41ff81d1f))
* **lua:** fix target selection to wait longer ([e98d4ea](https://github.com/FFFishes7/balatrobot/commit/e98d4ea7c5f6673d2e5b397c2eb5fdbc75b7bd04))
* **make:** add SKILL.md to mdformat ([c171122](https://github.com/FFFishes7/balatrobot/commit/c1711220acc969feb03abac159e59d409af2cab0))
* **make:** correct worker count message for tests/cli ([6e5fdd4](https://github.com/FFFishes7/balatrobot/commit/6e5fdd422e9f93a15df5409baa4ed75e1e91e7bb))
* **makefile:** update fixtures target to use updated CLI ([c160f04](https://github.com/FFFishes7/balatrobot/commit/c160f0458533cab9c3bc34290e2d514813606839))
* **metadata:** change the Steamodded dependency to include betas. ([c37a6b4](https://github.com/FFFishes7/balatrobot/commit/c37a6b458b91babfdc00e173d861b8947c1b7485))
* prevent memory leaks generating UI descriptions ([e8d62e1](https://github.com/FFFishes7/balatrobot/commit/e8d62e1146fd156e44b1af4d124270bbda5b2c16))
* **scripts:** wait for port to be ready in launcher scripts ([57508e7](https://github.com/FFFishes7/balatrobot/commit/57508e7f880a8c04beddbc8c65fd11939c2a6f2f))
* **server:** reject concurrent connections while client is active ([2942f19](https://github.com/FFFishes7/balatrobot/commit/2942f1943e41495976e5a38f81ac3962fc9f37c5))
* update makefile to use new --ports option ([3c76367](https://github.com/FFFishes7/balatrobot/commit/3c763676faf45c1e51c86c7e8e8ef2bc14ea47e3))
* update makefile to use the correct path for basedpyright ([e02ae34](https://github.com/FFFishes7/balatrobot/commit/e02ae34f023846a2a5cfa69373ae1068a544ffce))
* **utils:** add won field to gamestate ([b80af60](https://github.com/FFFishes7/balatrobot/commit/b80af606157b9851d9b26b6a5fffe0a4a48e264a))
* **utils:** improve gamestate get_blinds_info and make it public ([5e4d071](https://github.com/FFFishes7/balatrobot/commit/5e4d07196ba78f2d839aa85ec36ff4e0de126c4b))
* **utils:** improve gamestate get_blinds_info and make it public ([5e4d071](https://github.com/FFFishes7/balatrobot/commit/5e4d07196ba78f2d839aa85ec36ff4e0de126c4b))
* **validator:** revert to old behaviour for array items ([729e164](https://github.com/FFFishes7/balatrobot/commit/729e164105a221c5233255ba6b09a91fae2fb2f5))


### Performance Improvements

* change pytest-xdist config from loadfile to loadscope ([d7c2a28](https://github.com/FFFishes7/balatrobot/commit/d7c2a289f61ea748778dfe83d94ffcf15767cbd0))
* **lua.endpoints:** go back to menu only if not already in menu ([bc34e13](https://github.com/FFFishes7/balatrobot/commit/bc34e13a08197c76669f9148a4ddd600def45796))
* **make:** change XDIST_WORKERS to 2 for tests/cli ([27240c8](https://github.com/FFFishes7/balatrobot/commit/27240c87875e01c1f2ec89553a80b75d37347191))


### Documentation

* add assets for balatrobot, balatrollm, and balatrobench ([d80fba1](https://github.com/FFFishes7/balatrobot/commit/d80fba1a58a6642c9ef0c13e1ce30774bc6df811))
* add cli reference ([266b51d](https://github.com/FFFishes7/balatrobot/commit/266b51d6d2404fe25679e369ca13835b7def6d2a))
* add cli reference to mkdocs config ([8cba067](https://github.com/FFFishes7/balatrobot/commit/8cba06771c6e2f2e08d4a448119d938014675522))
* add conventional commits guideline to contributing ([bf164b1](https://github.com/FFFishes7/balatrobot/commit/bf164b12a58de69826efc1929db9ed6ab6c7ad87))
* add docs/api.md ([5fd345c](https://github.com/FFFishes7/balatrobot/commit/5fd345c1b62a38485df8bbe275a6875ec1616283))
* add python syntax highlighting ([abe7cf4](https://github.com/FFFishes7/balatrobot/commit/abe7cf4c853d8afdf34d269570124e047914680f))
* add related projects and v1 warning ([7be30b4](https://github.com/FFFishes7/balatrobot/commit/7be30b43de63c608dbc6ed535b2a7b47d64328d0))
* add stirby to contributors in balatrobot.json ([3187e0a](https://github.com/FFFishes7/balatrobot/commit/3187e0ae73b89246d28d7bbf1b1dd6faa0b26f59))
* **api:** add required state for rearrange endpoint ([481d579](https://github.com/FFFishes7/balatrobot/commit/481d579ae3c610320e13937eeadcbd45de554cb8))
* **api:** Adding missing cards to GameState schema ([6c4f192](https://github.com/FFFishes7/balatrobot/commit/6c4f1921a45ca805e91ac0ffa4578d0bbc5ec9f5))
* **api:** fix api.md formatting ([4c85dec](https://github.com/FFFishes7/balatrobot/commit/4c85decdb9598433ac7295650181aad0b51cd92e))
* **api:** remove comment from the gamestate example ([44a169f](https://github.com/FFFishes7/balatrobot/commit/44a169f1d9c28b96fc20108efe508bc558a86e56))
* **api:** update the `add` endpoint to support packs ([36868f2](https://github.com/FFFishes7/balatrobot/commit/36868f27d1c8c6871580f6c6a20e60b5d278a194))
* **ci:** version docs with mike for main, tags, and dev ([e7c6db8](https://github.com/FFFishes7/balatrobot/commit/e7c6db8a9ad88318f6e4128eefd6e61aafc94885))
* **claude:** add allowed-tools and jq examples to balatrobot SKILL.md ([a334125](https://github.com/FFFishes7/balatrobot/commit/a33412592ec5beab4f084761a868f6bbb26ae39d))
* **claude:** add balatrobot SKILL ([b44dede](https://github.com/FFFishes7/balatrobot/commit/b44dedeea096a1fe9b832347c9f9480b1d5b4b5e))
* **CLAUDE:** add GitHub repo link to CLAUDE.md ([9013de0](https://github.com/FFFishes7/balatrobot/commit/9013de0b30ce5db957cee7833c81f764604b4103))
* **claude:** use absolute paths in screenshot endpoint in SKILL.md ([1d961b7](https://github.com/FFFishes7/balatrobot/commit/1d961b7e658422e5becc9d3a6511ccaa02f9f183))
* **cli:** `run_lovely_macos.sh` is not required ([ccf1996](https://github.com/FFFishes7/balatrobot/commit/ccf1996fe9e960ed10e25b783500ae3b806debfd))
* **cli:** add hyprland config tip ([f848dff](https://github.com/FFFishes7/balatrobot/commit/f848dffa24c4da3391644618acab80191f070213))
* **cli:** add new cli commands - serve and api ([b8355af](https://github.com/FFFishes7/balatrobot/commit/b8355af0bbf9c15aaf9cc5b7eb0b73b395dd49e7))
* **cli:** remove --parallel option ([b870437](https://github.com/FFFishes7/balatrobot/commit/b870437c429f1e65d69e7aea281a202cc1967658))
* **cli:** remove resize rule in hyperland config example ([ace84b5](https://github.com/FFFishes7/balatrobot/commit/ace84b59db8eb7a5051843adbad0f9dbd86fb32e))
* **contributing:** add linux native symlink location ([d07c354](https://github.com/FFFishes7/balatrobot/commit/d07c35430ef9ea438c11fa22abc82703ef92f5f8))
* **contributing:** add note about running tests separately ([684dbcc](https://github.com/FFFishes7/balatrobot/commit/684dbcc79e6284e84a49adacd9d25edb284a9d28))
* **contributing:** add windows/linux (proton) support ([e9807ad](https://github.com/FFFishes7/balatrobot/commit/e9807ad5ea2201614b7607426528dbf7a38df932))
* **contributing:** improve contributing guide ([d5576b2](https://github.com/FFFishes7/balatrobot/commit/d5576b2c50da5f5488c1cca1c0e5cf3f61025408))
* **contributing:** update .luarc.json example ([c9c486a](https://github.com/FFFishes7/balatrobot/commit/c9c486a4bd6c660bf0feb4a54175d55f69128df1))
* docs fixes ([099147a](https://github.com/FFFishes7/balatrobot/commit/099147aaaffd99e516844f90b4f0b721927f128a))
* **endpoints:** fix pack_select formatting ([535e3b0](https://github.com/FFFishes7/balatrobot/commit/535e3b00b45f658680383e278ec887fca566a90b))
* **endpoints:** fix pack_select formatting ([7c0535c](https://github.com/FFFishes7/balatrobot/commit/7c0535c5bf93e87ec54da4c326fe42ce91c7e296))
* **example-bot:** add example bot page ([73c4313](https://github.com/FFFishes7/balatrobot/commit/73c431325877dd38e2b43f67a7ac275da5239ba9))
* **example-bot:** add missing link to polina4096/Ballad community bot ([0f7910a](https://github.com/FFFishes7/balatrobot/commit/0f7910a78695535d637d706956ebca76ecefe7bf))
* **example-bot:** add polina4096/Ballad to community bot ([f7c421f](https://github.com/FFFishes7/balatrobot/commit/f7c421f1bbcaa07960468551e984dab78a6672ce)), closes [#153](https://github.com/FFFishes7/balatrobot/issues/153)
* fix formatting for contributing.md ([987de25](https://github.com/FFFishes7/balatrobot/commit/987de257d3013398ee6967ac03850db7aaec2ae5))
* fix minor english issues ([369372c](https://github.com/FFFishes7/balatrobot/commit/369372c59fbd9c3a0c014cb4e7e9bf1707566188))
* improve docs over all ([5ed0eb3](https://github.com/FFFishes7/balatrobot/commit/5ed0eb32ba3a8c9ba770cfbca5a4c88d38285b37)), closes [#152](https://github.com/FFFishes7/balatrobot/issues/152)
* **index:** add links to balatrollm and balatrobench ([7662f98](https://github.com/FFFishes7/balatrobot/commit/7662f9818eff1b6a1f9abab4d486c317e0cd5a7f))
* **index:** equal size for all images and add underline ([c84091a](https://github.com/FFFishes7/balatrobot/commit/c84091ac98cacbb6fe53eaeb1390f9412909cc8b))
* **index:** fix link to BalatroBot in index.md ([09eee0e](https://github.com/FFFishes7/balatrobot/commit/09eee0eeb21dddf90cc3df97525040e0e255ddad))
* **index:** remove link to legacy docs ([23029cd](https://github.com/FFFishes7/balatrobot/commit/23029cd0b8bdbe33f7ed41c02c9aed8e37da837d))
* **installation:** add version requirements ([b567359](https://github.com/FFFishes7/balatrobot/commit/b567359d48e2e114a02ca4023a36cf69650ec6c9))
* **installation:** fixing releases link ([fa5abf1](https://github.com/FFFishes7/balatrobot/commit/fa5abf1619dec6c909abdfaeec567340377082cf))
* **lua.utils:** add missing descriptions to enums ([21f47c9](https://github.com/FFFishes7/balatrobot/commit/21f47c9fcbe419d93921fec357d3c32ec275e844))
* **lua.utils:** be more explicit about supported modifiers ([ffefcd2](https://github.com/FFFishes7/balatrobot/commit/ffefcd23eda828784b8b0974807d26d6ace96f5b))
* **lua.utils:** document error name conversion ([98a72fa](https://github.com/FFFishes7/balatrobot/commit/98a72fabeb440cb74ee9e2a41de4242f6eecc757))
* minor section rename in index.md ([1bf0cc7](https://github.com/FFFishes7/balatrobot/commit/1bf0cc7d86174a6fa4bf0d9c89b00253622c8738))
* **mkdocs:** set accent color to shades of orange ([89b43dc](https://github.com/FFFishes7/balatrobot/commit/89b43dc947b516380b79e875073fd17da6f9d710))
* prepend `uvx` to balatrobot command ([e9e48e1](https://github.com/FFFishes7/balatrobot/commit/e9e48e1b97fcda33f15e174d8acc926387b17027))
* **readme:** move aknowledgments to bottom ([7e777d4](https://github.com/FFFishes7/balatrobot/commit/7e777d40663b3194c4ebe8edac072c63b056e00b))
* **readme:** remove coming soon from release project ([aa15fd5](https://github.com/FFFishes7/balatrobot/commit/aa15fd590ad40d00ef4501f40a76716d9fff78b8))
* **readme:** remove the imgs from the related project section ([354de3a](https://github.com/FFFishes7/balatrobot/commit/354de3a2f2966dcd98e5c62751b740804d5b1afb))
* remove mkdocs site config and clean up README ([05e07df](https://github.com/FFFishes7/balatrobot/commit/05e07df18a76941d720d49ae1ddc04868e6ed5dd))
* remove the breaking changes warning ([b92afe3](https://github.com/FFFishes7/balatrobot/commit/b92afe3ecfb0416d88e1db911619b91665a28103))
* setup favicon and logo for the docs ([c086549](https://github.com/FFFishes7/balatrobot/commit/c08654999632973a013aa64a78f6936bbb3d08bf))
* update CLAUDE.md with new files and tests structure ([72c6026](https://github.com/FFFishes7/balatrobot/commit/72c602653523136e87b05414dacc0fa0afe7e959))
* update deps and style of the docs ([784b780](https://github.com/FFFishes7/balatrobot/commit/784b780ce6c51cbd57e6694b624a75add9aa7df0))
* update docs for new BalatroBot API ([d80b9ba](https://github.com/FFFishes7/balatrobot/commit/d80b9ba3cc1d50ece6f03c80ae2e74154eb64436))
* update documentation for Linux (Proton) support ([5a345ec](https://github.com/FFFishes7/balatrobot/commit/5a345ec33de249c26f3ccc29414a261086248d67))
* update installation guide with new launcher scripts ([2b3eea4](https://github.com/FFFishes7/balatrobot/commit/2b3eea499bd6c07e7bbc4d5095cb5b087d35fa18))
* update the overview in README.md and update the main image ([e471cf0](https://github.com/FFFishes7/balatrobot/commit/e471cf0d6ce65b311143143b418a16cc2ba73fd1))
* update warning banner with new CLI ([bb3b346](https://github.com/FFFishes7/balatrobot/commit/bb3b3461b52fe17123fed339285a9a57312a5a08))
* use white logo version for docs logo ([e532087](https://github.com/FFFishes7/balatrobot/commit/e5320870f08b93191de35b4d57ab5dd501b50dd4))


### Miscellaneous Chores

* force 1.0.0 release ([a887d1c](https://github.com/FFFishes7/balatrobot/commit/a887d1c516756856bff4ff61b628266495086605))


### Continuous Integration

* **release:** move release notification to pypi workflow ([2274781](https://github.com/FFFishes7/balatrobot/commit/2274781d66cdc32a09f618b5058542dc1e4dc2b4))
